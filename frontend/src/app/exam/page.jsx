            ...
            >
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  multiple
                />
                <label htmlFor="file-upload-exam">
              ...
              <div className="flex items-center justify-center h-full w-full">
                <div className="text-center max-w-md px-6">
                  ...
                  <p className="text-muted-foreground">
                    Upload past exam questions and click generate to create similar questions
                  </p>
                </div>
              </div>
            ) : (
              <>
                <div
                  className={`overflow-y-auto p-6 space-y-3 border-r transition-all duration-300 ${
                    expandedQuestion ? "hidden md:block md:w-64 md:opacity-50 pointer-events-none md:pointer-events-auto" : "w-full md:w-2/5"
                  }`}
                >
                  <div className="mb-4">
